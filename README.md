# Asus-Z170-A-Opencore 0.7.8

This is an OpenCore version of ASUS Z170-A Hackintosh EFI. It works on macOS Monterey 12.2.1 (21D62). FCPX GPU rendering works smoothly. HDR can be enabled.
